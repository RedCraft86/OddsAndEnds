...
public class CommonCfg {
    ...
    public static final ForgeConfigSpec.BooleanValue CRYING_PORTALS;
    ...
    public static final ForgeConfigSpec.BooleanValue NO_PET_ATTACK;
    public static final ForgeConfigSpec.BooleanValue NO_VILLAGER_ATTACK;
    public static final ForgeConfigSpec.BooleanValue NO_TEMPT_COOLDOWN;
    public static final ForgeConfigSpec.BooleanValue INFINITE_VILLAGERS;

    public static final ForgeConfigSpec.IntValue SOULFIRE_EFFECT_RANGE;
    public static final ForgeConfigSpec.BooleanValue SOULFIRE_CLEAR_HARM;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> SOULFIRE_EFFECTS;

    public static final ForgeConfigSpec.BooleanValue DIRT_TO_GRASS;
    public static final ForgeConfigSpec.BooleanValue SNEAKY_GRASS_CHANCE;
    public static final ForgeConfigSpec.IntValue SHORT_GRASS_CHANCE;
    public static final ForgeConfigSpec.IntValue TALL_GRASS_CHANCE;
    public static final ForgeConfigSpec.IntValue RANDOM_FLOWER_CHANCE;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> FLOWER_BLACKLIST;

    public static final ForgeConfigSpec.IntValue SEARCH_RADIUS;
    public static final ForgeConfigSpec.ConfigValue<String> STRUCTURE_SPAWNPOINT;
    public static final ForgeConfigSpec.BooleanValue RANDOM_TAGGED_STRUCTURE;
